...
- Empezar por dar el estilo adecuado a las clases vacías correspondientes a los campos del formulario, tener en la clase padre del div form-control
  ...
  - La propiedad position es fundamental en este reto, revisar cual deberá ir como relative
   y absolute en input y label respectivamente.
  - Crear los estilos del input apoyandose de un background transparente, color de fuente blanca 
  y una línea en la parte inferior del campo.


- Botón
   - dar una propiedad transform adecuada (según lo que se ve en el video) en la 
    .btn:active
