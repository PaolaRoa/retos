...
-  El CSS está completo pero deben practicar y entender cómo funciona el keyframe 
grow para la animación del corazón


JS

Revisar cómo funciona la creación de doble click a través 
de loveMe.addEventListener('click', (e) => { ... })
...
deben quitar los corazones después de que aparezcan.  
(aunque no se ven en el front quedan cómo código, validar por consola)
